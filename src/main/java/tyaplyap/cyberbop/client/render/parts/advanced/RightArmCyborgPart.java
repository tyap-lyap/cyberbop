...
import tyaplyap.cyberbop.client.model.advanced.RightArmModel;
import tyaplyap.cyberbop.client.render.parts.CyborgPartRenderer;

public class RightArmCyborgPart extends CyborgPartRenderer {

	ModelPart model;
	String texture;
	public final EntityModelLayer layer;

	public RightArmCyborgPart(String name, String texture) {
		super(name);
	...
	public void register() {
		EntityModelLayerRegistry.registerModelLayer(layer, RightArmModel::getTexturedModelData);
	}
}
