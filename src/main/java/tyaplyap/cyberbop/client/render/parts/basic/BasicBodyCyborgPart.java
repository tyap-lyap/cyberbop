...
import tyaplyap.cyberbop.client.model.basic.BasicBodyModel;
import tyaplyap.cyberbop.client.render.parts.CyborgPartRenderer;

public class BasicBodyCyborgPart extends CyborgPartRenderer {

	ModelPart model;
	String texture;
	public final EntityModelLayer layer;

	public BasicBodyCyborgPart(String name, String texture) {
		super(name);
	...
	public void register() {
		EntityModelLayerRegistry.registerModelLayer(layer, BasicBodyModel::getTexturedModelData);
	}
}
