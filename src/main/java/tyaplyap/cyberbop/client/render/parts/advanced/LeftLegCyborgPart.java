...
import tyaplyap.cyberbop.client.model.advanced.LeftLegModel;
import tyaplyap.cyberbop.client.render.parts.CyborgPartRenderer;

public class LeftLegCyborgPart extends CyborgPartRenderer {

	ModelPart model;
	String texture;
	public final EntityModelLayer layer;

	public LeftLegCyborgPart(String name, String texture) {
		super(name);
	...
	public void register() {
		EntityModelLayerRegistry.registerModelLayer(layer, LeftLegModel::getTexturedModelData);
	}
}
