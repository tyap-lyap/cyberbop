...
import tyaplyap.cyberbop.client.model.advanced.LeftArmModel;
import tyaplyap.cyberbop.client.render.parts.CyborgPartRenderer;

public class LeftArmCyborgPart extends CyborgPartRenderer {

	ModelPart model;
	String texture;
	public final EntityModelLayer layer;

	public LeftArmCyborgPart(String name, String texture) {
		super(name);
	...
	public void register() {
		EntityModelLayerRegistry.registerModelLayer(layer, LeftArmModel::getTexturedModelData);
	}
}
