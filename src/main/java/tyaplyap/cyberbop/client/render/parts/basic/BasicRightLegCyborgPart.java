...
import tyaplyap.cyberbop.client.model.basic.BasicRightLegModel;
import tyaplyap.cyberbop.client.render.parts.CyborgPartRenderer;

public class BasicRightLegCyborgPart extends CyborgPartRenderer {

	ModelPart model;
	String texture;
	public final EntityModelLayer layer;

	public BasicRightLegCyborgPart(String name, String texture) {
		super(name);
	...
	public void render(PlayerEntityModel<?> contextModel, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, LivingEntity entity) {
		...
		model.copyTransform(contextModel.rightLeg);
	...
	public void renderAssembler(float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
		...
		matrices.translate(0.615, 1.75, 0.5);
	...
	public void register() {
		EntityModelLayerRegistry.registerModelLayer(layer, BasicRightLegModel::getTexturedModelData);
	}
}
