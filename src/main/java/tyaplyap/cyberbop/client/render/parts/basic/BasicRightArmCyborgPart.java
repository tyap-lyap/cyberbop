...
import tyaplyap.cyberbop.client.model.basic.BasicRightArmModel;
import tyaplyap.cyberbop.client.render.parts.CyborgPartRenderer;

public class BasicRightArmCyborgPart extends CyborgPartRenderer {

	ModelPart model;
	String texture;
	public final EntityModelLayer layer;

	public BasicRightArmCyborgPart(String name, String texture) {
		super(name);
	...
	public void render(PlayerEntityModel<?> contextModel, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, LivingEntity entity) {
		...
		model.copyTransform(contextModel.rightArm);
	...
	public void renderAssembler(float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
		...
		matrices.translate(0.81, 2.35, 0.5);
	...
	public void register() {
		EntityModelLayerRegistry.registerModelLayer(layer, BasicRightArmModel::getTexturedModelData);
	}
}
