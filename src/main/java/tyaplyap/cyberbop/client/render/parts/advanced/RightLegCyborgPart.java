...
import tyaplyap.cyberbop.client.model.advanced.RightLegModel;
import tyaplyap.cyberbop.client.render.parts.CyborgPartRenderer;

public class RightLegCyborgPart extends CyborgPartRenderer {

	ModelPart model;
	String texture;
	public final EntityModelLayer layer;

	public RightLegCyborgPart(String name, String texture) {
		super(name);
	...
	public void register() {
		EntityModelLayerRegistry.registerModelLayer(layer, RightLegModel::getTexturedModelData);
	}
}
