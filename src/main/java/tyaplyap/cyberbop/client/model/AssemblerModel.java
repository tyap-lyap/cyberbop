...
public class AssemblerModel extends Model {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData handle = modelPartData.addChild("handle", ModelPartBuilder.create().uv(0, 32).cuboid(-1.0F, -28.0F, 4.0F, 2.0F, 12.0F, 2.0F, new Dilation(0.0F))
			.uv(8, 32).cuboid(-2.0F, -31.0F, 3.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F))
			.uv(24, 32).cuboid(-5.0F, -40.0F, 1.0F, 10.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
