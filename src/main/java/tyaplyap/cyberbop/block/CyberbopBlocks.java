...
public class CyberbopBlocks {
	...
	public static final Block CHRONOSTEEL_BLOCK = add("chronosteel_block", new Block(AbstractBlock.Settings.create().requiresTool().strength(2.0f, 4.0f).sounds(BlockSoundGroup.COPPER)));
	...
	public static final Block SOLAR_PANEL = add("solar_panel", new SolarPanelBlock(16000, 2, AbstractBlock.Settings.create().requiresTool().strength(2.0f, 4.0f).sounds(BlockSoundGroup.METAL)));
	public static final Block ADVANCED_SOLAR_PANEL = add("advanced_solar_panel", new SolarPanelBlock(32000, 8, AbstractBlock.Settings.create().requiresTool().strength(2.0f, 4.0f).sounds(BlockSoundGroup.METAL)));
	...
	public static final Block BATTERY_BLOCK = add("battery_block", new EnergyBatteryBlock(AbstractBlock.Settings.create().strength(1.0f, 3.0f)));
