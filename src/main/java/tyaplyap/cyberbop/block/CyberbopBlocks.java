...
public class CyberbopBlocks {
	...
	public static final Block FURNACE_GENERATOR = add("furnace_generator", new FurnaceGeneratorBlock(AbstractBlock.Settings.create().strength(2.0f, 4.0f).sounds(BlockSoundGroup.METAL)));
